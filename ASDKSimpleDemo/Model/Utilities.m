...
+ (NSString *)elapsedTimeStringSinceDate:(NSString *)uploadDateString
{
  ...
  if (days > 7) {
    elapsedTime = [NSString stringWithFormat:@"%lu周前", (long)ceil(days/7.0)];
  } else if (days > 0) {
    elapsedTime = [NSString stringWithFormat:@"%lu天前", (long)days];
  } else if (hours > 0) {
    elapsedTime = [NSString stringWithFormat:@"%lu小时前", (long)hours];
  } else if (minutes > 0) {
    elapsedTime = [NSString stringWithFormat:@"%lu分前", (long)minutes];
  } else if (seconds > 0) {
    elapsedTime = [NSString stringWithFormat:@"%lu秒前", (long)seconds];
  } else if (seconds == 0) {
    elapsedTime = @"1s";
  } else {
    elapsedTime = @"ERROR";
